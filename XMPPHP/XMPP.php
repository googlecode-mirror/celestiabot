...
//MUC UNITS
    ...
    public function income_iq($xml) {
        ...
        if ($this->ver_type == 'ping') {
            ...
            if ($this->ver_chat_type == 'chat')
                $this->message($this->ver_to, 'Pong: ' . substr($totaltime1, 0, 4). " sec.", $this->ver_chat_type);
            if ($this->ver_chat_type == 'groupchat')
                $this->message($this->tconf, $this->user_name_inconf . ': Pong: ' . substr($totaltime1, 0, 4). " sec.", $this->ver_chat_type);
            $this->ver_type = 'none';
        }
    }
